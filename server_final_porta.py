...
if __name__ == "__main__":
    print("=" * 50)
    print("??? WeatherAlert Server - Versao Final")
    print("=" * 50)
    ...
    print(f"?? Frio: http://127.0.0.1:8000/alerta/frio/PortoAlegre?temp=5")
    print(f"??? Clima: http://127.0.0.1:8000/weather/now/SaoPaulo")
